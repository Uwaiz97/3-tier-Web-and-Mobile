...
class LandlordGateway extends Dbh
{
    ...
    {
        $sql = "INSERT INTO landlord (landlord_id, landlord_blaclistStatus) 
                VALUES (:landlord_id, :landlord_blaclistStatus)";

        $stmt = $this->connect()->prepare($sql);

        $stmt->bindValue(":landlord_id", $data["landlord_id"], PDO::PARAM_INT);
        $stmt->bindValue(":landlord_blaclistStatus", false, PDO::PARAM_BOOL);
    ...
    {
        $sql = "UPDATE landlord
                SET landlord_id = :landlord_id, landlord_blaclistStatus = :landlord_blaclistStatus
                WHERE landlord_id = :landlord_id";
